...
def load_resources():
    try:
        ...
        st.error("Model or vectorizer file not found. Make sure 'tuned_logistic_regression_model.pkl' and 'tfidf_vectorizer.pkl' are in the same directory.")
        return None, None
...
if st.button('Predict Sentiment'):
    if model and vectorizer:
        ...
        st.warning('Model or vectorizer not loaded. Please check the file paths.')
